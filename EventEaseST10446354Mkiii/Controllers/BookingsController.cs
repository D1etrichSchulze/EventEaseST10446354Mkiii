...
namespace EventEaseST10446354Mkiii.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public BookingsController(EventEaseST10446354MkiiiContext context)
        {
            _context = context;
        }
        ...
        {
            var eventEaseST10446354MkiiiContext = _context.Booking.Include(b => b.Event).Include(b => b.Venue);
            return View(await eventEaseST10446354MkiiiContext.ToListAsync());
        }
